...
module.exports = {
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: '🎮 Oyun Sistemi', value: 'oyun' }, { name: '👥 Grup Sistemi', value: 'grup' }, { name: '💬 Mesaj Sistemi', value: 'mesaj' }, { name: '💰 Bakiye Sistemi', value: 'bakiye' }, { name: '⚔️ Düello Sistemi', value: 'duello' }, { name: '🏴☠️ Faction Sistemi', value: 'faction' }, { name: '📋 Tüm Komutlar', value: 'komut' }, { name: '🚀 Başlangıç Rehberi', value: 'onboarding' })),
