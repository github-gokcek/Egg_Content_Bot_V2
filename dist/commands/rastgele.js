...
module.exports = {
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: 'D2 (1-2)', value: 'd2' }, { name: 'D5 (1-5)', value: 'd5' }, { name: 'D10 (1-10)', value: 'd10' }, { name: 'D25 (1-25)', value: 'd25' }, { name: 'D50 (1-50)', value: 'd50' }, { name: 'D100 (1-100)', value: 'd100' }, { name: 'Yazı Tura', value: 'yazı-tura' }))
    ...
    async execute(interaction) {
        ...
        // Quest tracking
        try {
            await questService_1.questService.trackRastgeleUsed(interaction.user.id);
        }
        catch (error) {
