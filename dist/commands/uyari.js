...
async function execute(interaction) {
    ...
    const warningCount = await (0, warningService_1.addMajorWarning)(interaction.guildId, targetUser.id);
    // Rolü ver
    ...
    const embed = new discord_js_1.EmbedBuilder()
        ...
        .addFields({ name: 'Sebep', value: reason }, { name: 'Toplam Uyarı', value: `${warningCount}/2`, inline: true }, { name: 'Yetkili', value: interaction.user.tag, inline: true })
        .setTimestamp();
    if (warningCount >= 2) {
