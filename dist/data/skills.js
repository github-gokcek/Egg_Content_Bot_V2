...
exports.getSkillsByClass = getSkillsByClass;
...
// Get skills by class
function getSkillsByClass(characterClass) {
    return Object.values(exports.SKILLS).filter(skill => skill.class === characterClass);
}
// Get skill by ID
...
function getAvailableSkills(characterClass, level) {
